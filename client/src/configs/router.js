...
const masterRoute = [
  {
    name: '用户',
    permission:
      'USER_CREATE | USER_SELECT | ROLE_CREATE | ROLE_SELECT | PERMISSION_CREATE | PERMISSION_SELECT',
    path: '_user_group',
    icon: 'user',
    allow: false,
    children: [
...
export { masterRoute, UserPagePermission, RolePagePermission, PermissionPagePermission };
